...
message("=== Starting GSE19429 GSEA===")
...
res_h <- gsea_lollipop(obj = hallmarks_H, db_name = "Hallmark", color = "firebrick", title = "GSEA enrichment analysis – HallMarks H: Major Biological Processes")

# Category -> C3 (Transcription Factor Targets)
...
res_c3 <- gsea_lollipop(obj = hallmarks_C3, db_name = "Hallmark", color = "steelblue", title = "GSEA enrichment analysis – HallMarks C3: Transcription Factor Targets")
...
res_c7 <- gsea_lollipop(obj = hallmarks_C7, db_name = "Hallmark", color = "darkgreen", title = "GSEA enrichment analysis – HallMarks C7: Immunologic signatures")
...
res_c8 <- gsea_lollipop(obj = hallmarks_C8, db_name = "Hallmark", color = "indianred4", title = "GSEA enrichment analysis – HallMarks C8: Cell Type signatures")
...
# Kegg
save_csv(kegg_df, filename = "results_GSE19429_GSEA_kegg_df.csv", dir = paths$tables_gsea)

# HallMarks H Collection
save_csv(hallmarks_H_df_clean, filename = "results_GSE19429_GSEA_hallmarks_h_df.csv", dir = paths$tables_gsea)
...
# Reactome 
save_plot(res_reactome[[1]], filename = "23_GSEA_reactome.png", dir = paths$plots_gse19429_gsea, width = 11, height = 9)

# HallMarks 
save_plot(res_h[[1]], filename = "24_GSEA_hallmarks_H.png", dir = paths$plots_gse19429_gsea, width = 11, height = 9)
save_plot(res_c3[[1]], filename = "25_GSEA_hallmarks_C3.png", dir = paths$plots_gse19429_gsea, width = 11, height = 9)
save_plot(res_c7[[1]], filename = "26_GSEA_hallmarks_C7.png", dir = paths$plots_gse19429_gsea, width = 15, height = 9)
save_plot(res_c8[[1]], filename = "27_GSEA_hallmarks_C8.png", dir = paths$plots_gse19429_gsea, width = 11, height = 9)

# Enrichment score
save_plot(enrich_IFN_a, filename = "28_GSEA_enrichmentscore_IFN-A.png", dir = paths$plots_gse19429_gsea, width = 11, height = 9)
save_plot(enrich_IFN_g, filename = "29_GSEA_enrichmentscore_IFN-Gamma.png", dir = paths$plots_gse19429_gsea, width = 11, height = 9)

# Kegg
save_plot(res_kegg[[1]], filename = "30_GSEA_kegg.png", dir = paths$plots_gse19429_gsea, width = 11, height = 9)
...
save_session_info(filename = "sessionInfo_GSEA_GSE19429.txt", dir = paths$logs, label = "Gene Set Enrichment Analysis (GSEA)- GSE19429")
...
message("=================================================")
message("[PIPELINE] Gene Set Enrichment Analysis completed successfully for GSE19429 (MDS vs Healthy Controls).")
message("=================================================")
