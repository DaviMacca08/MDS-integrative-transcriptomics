...
message("=== Starting GSE19429 Pathview===")
...
withr::with_dir(
  "results/GSE19429_microarray/PathView/",
  {
    pathview(
...
save_session_info(filename = "sessionInfo_Pathview_GSE19429.txt", dir = paths$logs, label = "Pathway Visualization with Pathview - GSE19429)")
...
message("=================================================")
message("[PIPELINE] Pathway visualization with Pathview completed successfully for GSE19429 (MDS vs Healthy Controls).")
message("=================================================")
