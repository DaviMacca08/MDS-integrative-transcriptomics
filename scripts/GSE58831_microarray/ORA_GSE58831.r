...
# Samples      : 159 MDS patients + 17 healthy controls, CD34+ bone marrow HSC
...
message("=== Starting over-representation analysis for GSE58831 ===")
...
background <- read.csv(file = file.path(paths$tables, "background_GSE58831.csv"), sep = "," )
...
save_plot(go_all_plot, filename = "11-GO_all_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(go_up_plot, filename = "12-GO_Up_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(go_down_plot, filename = "13-GO_Down_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
...
save_plot(kegg_all_plot, filename = "14-KEGG_all_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(kegg_up_plot, filename = "15-KEGG_up_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(kegg_down_plot, filename = "16-KEGG_down_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
...
save_plot(react_all_plot, filename = "17-Reactome_all_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(react_up_plot, filename = "18-Reactome_up_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(react_down_plot, filename = "19-Reactome_down_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
...
save_plot(hallmark_all_plot,  filename = "20-Hallmark_all_genes.png",  dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(hallmark_up_plot,   filename = "21-Hallmark_up_genes.png",   dir = paths$plots_gse58831_ora, width = 10, height = 9)
save_plot(hallmark_down_plot, filename = "22-Hallmark_down_genes.png", dir = paths$plots_gse58831_ora, width = 10, height = 9)
...
save_session_info(filename = "sessionInfo_ORA_GSE58831.txt", dir = paths$logs, label = "Over-Representation Analysis (ORA) - GSE58831")
...
message("=================================================")
message("[PIPELINE] Over-Representation Analysis completed successfully for GSE58831 (MDS vs Healthy Controls).")
message("=================================================")
