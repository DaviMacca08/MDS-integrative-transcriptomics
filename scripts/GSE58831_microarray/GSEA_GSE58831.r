...
message("=== Starting GSE58831 GSEA===")
...
# Kegg
save_csv(kegg_df, filename = "results_GSE58831_GSEA_kegg_df.csv", dir = paths$tables_gsea)

# HallMarks H Collection
save_csv(hallmarks_H_df_clean, filename = "results_GSE58831_GSEA_hallmarks_h_df.csv", dir = paths$tables_gsea)
...
# Reactome 
save_plot(res_reactome[[1]], filename = "23_GSEA_reactome.png", dir = paths$plots_gse58831_gsea, width = 11, height = 9)

# HallMarks 
save_plot(res_h[[1]], filename = "24_GSEA_hallmarks_H.png", dir = paths$plots_gse58831_gsea, width = 11, height = 9)
save_plot(res_c3[[1]], filename = "25_GSEA_hallmarks_C3.png", dir = paths$plots_gse58831_gsea, width = 11, height = 9)
save_plot(res_c7[[1]], filename = "26_GSEA_hallmarks_C7.png", dir = paths$plots_gse58831_gsea, width = 15, height = 9)
save_plot(res_c8[[1]], filename = "27_GSEA_hallmarks_C8.png", dir = paths$plots_gse58831_gsea, width = 11, height = 9)

# Enrichment score
save_plot(enrich_IFN_a, filename = "28_GSEA_enrichmentscore_IFN-A.png", dir = paths$plots_gse58831_gsea, width = 11, height = 9)
save_plot(enrich_IFN_g, filename = "29_GSEA_enrichmentscore_IFN-Gamma.png", dir = paths$plots_gse58831_gsea, width = 11, height = 9)

# Kegg
save_plot(res_kegg[[1]], filename = "30_GSEA_kegg.png", dir = paths$plots_gse58831_gsea, width = 11, height = 9)
...
save_session_info(filename = "sessionInfo_GSEA_GSE58831.txt", dir = paths$logs, label = "Gene Set Enrichment Analysis (GSEA)- GSE58831")
...
message("=================================================")
message("[PIPELINE] Gene Set Enrichment Analysis completed successfully for GSE58831 (MDS vs Healthy Controls).")
message("=================================================")
