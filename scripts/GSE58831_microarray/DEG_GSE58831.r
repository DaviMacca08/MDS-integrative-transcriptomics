...
message("=== Starting GSE58831 microarray analysis pipeline ===")
...
open_png(filename = "01_boxplot_intensity_distributions.png", dir = paths$plots_gse58831_qc,
         width = 1600, height = 900)
par(mar = c(8, 4, 4, 2))
boxplot(expr_log,
        main = "Log2 intensity distribution per sample (GSE58831)",
        ylab = "log2 intensity",
        col = sample_colors,
...
open_png(filename = "02_density_plot_intensity.png", dir = paths$plots_gse58831_qc, 
         width = 1200, height = 800)
plot(density(expr_log[, 1]), col = sample_colors[1], lwd = 1,
     main = "Density of log2 intensities across samples",
     xlab = "log2 intensity", ylim = c(0, 0.8))
...
pca_plot_group <- ggplot(pca_df, aes(PC1, PC2, color = group, shape = outlier)) +
  ...
  ggtitle("PCA of GSE58831 samples") +
  theme_bw()

save_plot(pca_plot_group, filename = "03_pca_plot.png", dir = paths$plots_gse58831_eda)
...
open_png(filename = "04_pca_scree_plot.png", dir = paths$plots_gse58831_eda,
...
open_png(filename = "05_hierarchical_clustering.png", dir = paths$plots_gse58831_eda,
...
open_png(filename = "06_sample_correlation_heatmap.png", dir = paths$plots_gse58831_eda,
...
pheatmap(
  ...
  show_rownames = FALSE, 
  show_colnames = FALSE,
  main = "Sample-sample Pearson correlation (GSE58831)"
)
...
open_png(filename = "07_sample_distance_heatmap.png", dir = paths$plots_gse58831_eda,
         width = 1400, height = 1400)
pheatmap(
...
volcano_plot_deg <- ggplot(deg_table,aes(x = logFC, y = -log10(adj.P.Val), color = significance)) +
  ...
  labs(
    title = "Volcano plot of differential expression (GSE58831)",
...
save_plot(volcano_plot_deg, filename = "08_volcano_plot.png", dir = paths$plots_gse58831_deg, 
          width = 8, height = 6)
...
open_png(filename = "09_MA_plot_MDS_vs_HC.png", dir = paths$plots_gse58831_deg,
...
# Plot
open_png(filename = "10-Heatmap_TopDegs_MDS_vs_HC.png", dir = paths$plots_gse58831_deg,
...
save_csv(deg_table, filename = "DEGs_GSE58831.csv", dir = paths$tables)

message("[OUTPUT] Saving background gene list for enrichment analyses...")

background <- rownames(expr_filt)

save_csv(background, filename = "background_GSE58831.csv", dir = paths$tables)
...
save_session_info(filename = "sessionInfo_DEG_GSE58831.txt", dir = paths$logs, label = "Differential expression analysis - GSE58831")
...
message("=================================================")
message("[PIPELINE] Differential expression analysis completed successfully for GSE58831 (MDS vs Healthy Controls).")
message("=================================================")
