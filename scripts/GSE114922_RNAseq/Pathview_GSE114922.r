...
# Dataset      : GSE114922 (Affymetrix HG-U133 Plus 2.0, GPL570)
...
message("=== Starting GSE114922 Pathview===")
...
list_pathview <- deg_table$log2FoldChange
...
withr::with_dir(
  "results/GSE114922_rnaseq/PathView/",
  {
    pathview(
...
save_session_info(filename = "sessionInfo_Pathview_GSE114922.txt", dir = paths$logs, label = "Pathway Visualization with Pathview - GSE114922)")
...
message("=================================================")
message("[PIPELINE] Pathway visualization with Pathview completed successfully for GSE114922 (MDS vs Healthy Controls).")
message("=================================================")
